using ABB.Developers.SDK.Data.Data;
using ABB.Developers.SDK.Data.Equipments;
using ABB.Developers.SDK.Data.Equipments.Base;
using ABB.Developers.SDK.Services.Devices;
using ABB.Developers.SDK.Services.Energies;
using ABB.Developers.SDK.Services.Plants;
...
namespace ABB.API.SDK.Template
{
    class Program
    {
